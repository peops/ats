                ...
                <section className="sidebar">
                    ...
                    <ul className="sidebar-menu" data-widget="tree">
                        ...
                        <ul className="treeview-menu">
                            <li><a href="pages/charts/chartjs.html"><i className="fa fa-circle-o"></i> Jobs </a></li>
                            <li><a href="pages/charts/morris.html"><i className="fa fa-circle-o"></i> Candidates </a></li>
                            <li><a href="pages/charts/flot.html"><i className="fa fa-circle-o"></i> Talent Pool </a></li>
                        </ul>
                        </li>
                        <li className="treeview">
                            <a href="#">
